...
export function CartDrawer() {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 z-50 bg-arca-ink/20 backdrop-blur-[2px]"
        onClick={closeCart}
        aria-hidden="true"
      />

      {/* Drawer */}
      <aside className="fixed top-0 right-0 z-50 h-full w-full max-w-md bg-arca-ivory flex flex-col shadow-2xl">
        {/* Header */}
